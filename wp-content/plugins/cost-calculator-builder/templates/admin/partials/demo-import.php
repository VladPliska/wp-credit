                ...
                <template v-if="!demoImport.load && !demoImport.progress_load">
                    ...
                    <div class="demo-btn-wrapper">
                        <div class="demo-btn-item">
                            <span class="ccb-demo-import-button default" @click="importDemos"><?php esc_html_e('Run Default Demo Import', 'cost-calculator-builder') ?></span>
                        </div>
                        ...
                        <div class="demo-btn-item ccb-file-upload">
                            ...
                            <span class="ccb-demo-import-button" @click="importNewLayout" :disabled="demoImport.noFile === 'No file chosen'" id="ccb-file-button"><?php esc_html_e('Import From File', 'cost-calculator-builder') ?></span>
                        </div>
