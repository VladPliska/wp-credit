<div class="total-wrapper">
    <div class="list-row">
        ...
        <div class="list-content">
            <h6><?php esc_html_e('Calculator Formula', 'cost-calculator-builder')?></h6>
            <textarea v-model="totalField.costCalcFormula" :ref="'ccb-formula-' + totalField._id"></textarea>
        </div>

        <div class="list-content">
            <h6><?php esc_html_e('Available Operators', 'cost-calculator-builder')?></h6>
        ...
        <div class="list-content">
            ...
            <h6><?php esc_html_e('Available Fields', 'cost-calculator-builder')?></h6>
