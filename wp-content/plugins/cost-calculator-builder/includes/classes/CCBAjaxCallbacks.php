...
class CCBAjaxCallbacks
{
    ...
    public static function save_settings()
    {
        ...
        if (isset($_POST['action']) && $_POST['action'] === 'calc_save_settings') {
            $data = apply_filters('stm_ccb_sanitize_array', $_POST);
    ...
    public static function demo_import_run()
    {
        ...
        if (isset($request_data['step']) && isset($request_data['key'])) {
            ...
            if ( isset($item['stm-fields']) ) {
                ...
                update_option('stm_ccb_form_settings_' . sanitize_text_field( $id ), apply_filters('stm_ccb_sanitize_array', $item['stm_ccb_form_settings']));
